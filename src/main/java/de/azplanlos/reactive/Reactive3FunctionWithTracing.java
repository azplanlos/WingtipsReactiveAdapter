...
public class Reactive3FunctionWithTracing<T, R> extends FunctionWithTracing<T, R> implements Function<T, R> {
    /**
     ...
     * @param origFunction
     */
    public Reactive3FunctionWithTracing(java.util.function.Function<T, R> origFunction) {
        super(origFunction);
    }
     ...
     */
    public Reactive3FunctionWithTracing(java.util.function.Function<T, R> origFunction, Pair<Deque<Span>, Map<String,
     ...
     */
    public Reactive3FunctionWithTracing(java.util.function.Function<T, R> origFunction, Deque<Span> spanStackForExecution,
     ...
     */
    public static <T, U> Reactive3FunctionWithTracing<T, U> withTracing(java.util.function.Function<T, U> origFunction) {
        return new Reactive3FunctionWithTracing<>(origFunction);
    }
}
