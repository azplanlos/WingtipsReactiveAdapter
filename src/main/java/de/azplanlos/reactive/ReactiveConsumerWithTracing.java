...
public class ReactiveConsumerWithTracing<T> extends ConsumerWithTracing<T> implements Consumer<T> {
    /**
     ...
     * @param origConsumer
     */
    public ReactiveConsumerWithTracing(java.util.function.Consumer<T> origConsumer) {
        super(origConsumer);
    }
     ...
     */
    public ReactiveConsumerWithTracing(java.util.function.Consumer<T> origConsumer, Pair<Deque<Span>, Map<String, String>> originalThreadInfo) {
     ...
     */
    public ReactiveConsumerWithTracing(java.util.function.Consumer<T> origConsumer, Deque<Span> spanStackForExecution, Map<String, String> mdcContextMapForExecution) {
     ...
     */
    public static <T> ReactiveConsumerWithTracing<T> withTracing(java.util.function.Consumer<T> origConsumer) {
        return new ReactiveConsumerWithTracing<>(origConsumer);
    }
}
